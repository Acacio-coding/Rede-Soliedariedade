...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(help_text='Digite o nome do representante da entidade', max_length=200)),
                ...
                ('data_cadastro', models.DateField(auto_now_add=True, verbose_name='data de cadastro')),
                ('representante', models.ForeignKey(help_text='Selecione o usuário representante', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_cadastro', models.DateField(auto_now_add=True, verbose_name='data de cadastro')),
                ('representante', models.ForeignKey(help_text='Selecione o representante da entidade', on_delete=django.db.models.deletion.CASCADE, to='gestao_de_doacoes.representante')),
            ],
            options={
